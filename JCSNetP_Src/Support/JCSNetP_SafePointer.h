#ifndef __JCSNETP_SAFEPOINTER_H__
/**
 * $File: JCSNetP_SafePointer.h $
 * $Date: 2017-04-16 23:24:55 $
 * $Revision: $
 * $Creator: Jen-Chieh Shen $
 * $Notice: See LICENSE.txt for modification and distribution information
 *                   Copyright (c) 2017 by Shen, Jen-Chieh $
 */
#define __JCSNETP_SAFEPOINTER_H__
...
/**
 * @func SafeDeleteSharedPtr
 * @brief Safe way to delete the shared pointer object.
 */
template <class T>
inline void SafeDeleteSharedPtr(T& ptr)
{
    if (ptr)
    {
        ptr.reset();
...
#endif /* __JCSNETP_SAFEPOINTER_H__ */
